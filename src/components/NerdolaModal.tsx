...
const NerdolaModal = ({ nerdola, isOpen, onClose }: NerdolaModalProps) => {
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-4 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 z-50 md:w-full md:max-w-2xl md:max-h-[90vh] overflow-auto rounded-2xl bg-card border border-border shadow-2xl"
          >
            {/* Close button */}
            <button
              onClick={onClose}
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {nerdola.curiosities.map((curiosity, index) => (
                    <motion.li
                      key={index}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {nerdola.phrases.map((phrase, index) => (
                    <motion.span
                      key={index}
